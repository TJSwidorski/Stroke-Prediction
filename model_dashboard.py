...
Imported by app.py. Call render() to display this section.
"""
...
def render():
    ...
    st.info(
        "This section reports Phase 3 modeling results. "
        "For Phase 1 descriptive analysis and Phase 2 hypothesis testing, "
        "use the navigation sidebar to switch to **Phase 1/2 — Data Analysis**."
    )
